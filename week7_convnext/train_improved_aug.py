...
from dataset import get_dataloaders_strong_aug
...
BEST_MODEL_PATH = (
    CHECKPOINT_DIR / "convnext_kernel3_ls_aug_best.pth"
)

HISTORY_PATH = (
    REPORT_DIR / "convnext_kernel3_ls_aug_history.csv"
)
...
def main():
    ...
    print("=" * 70)
    print(
        "ConvNeXt Kernel 3x3 + Label Smoothing "
    ...
    print("Strong augmentation: ColorJitter")
    print()
    ...
    # Validation loss는 기존 실험과 비교하기 위해
